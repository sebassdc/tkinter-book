...
tk.Entry(parent, width=60).grid(row=0, column=1 ,sticky='we', padx=2, pady=2, columnspan=9)

tk.Label(parent, text="Find:").grid(row=1, column=0, sticky='e', )
tk.Entry(parent).grid(row=1, column=1 ,sticky='we', padx=2, pady=2, columnspan=9)
